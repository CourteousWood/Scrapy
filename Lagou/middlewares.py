...
class RandomProxyMiddleware(object):
    #动态设置ip代理
    def process_request(self, request, spider):
        cur_datas = ['http://117.95.12.196:9999', 'http://116.209.56.61:9999', 'http://121.63.199.207:9999', 'http://112.85.130.57:9999','http://183.157.169.8:8118', 'http://117.95.12.196:9999', 'http://121.63.199.207:9999', 'http://59.62.164.142:9999', 'http://112.85.130.57:9999']
        request.meta["proxy"] = cur_datas[random.randint(0,len(cur_datas)-1)]
